...
run_characterize_quality = False
limit = 1000
...
if run_VAMP_analysis:
    possible_VAMPsequence_dict = {}
    with open(rf'{p["twist_sequence_file"]}', 'r',
              encoding='utf-8', newline='') as sequence_file:
        sequence_file_reader = csv.reader(sequence_file)
        for line in sequence_file_reader:
            possible_VAMPsequence_dict.update({line[0]: 0})
        sequence_file.close()
