...
def read_parameter_file(parameter_file_name):
    ...
    if p['expected_pairs']:
        ...
        print('index(c[0])=', p['randomized_bases'].index(c[0]))
        print('index(c[1])=', p['randomized_bases'].index(c[1]))
    # Print output
    ...
    with open(as_entered_file_address, 'w', encoding = 'utf-8',newline='') as output_file:
